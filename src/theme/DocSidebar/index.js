...
function DocSidebarItemCategory({
  ...
  const handleItemClick = (e) => useCallback(
    collapseItems(e)
  )
  if (items.length === 0) {
    return null;
  ...
  return (
    <li
      ...
      <a
        ...
        onClick={collapsible ? (e) => handleItemClick(item) : undefined}
...
function DocSidebarItem(props) {
  ...
  switch (props.item.type) {
    case 'category':
      return <DocSidebarItemCategory {...props} collapseItems={collapseItems} />;
...
function DocSidebar({path, sidebar, sidebarCollapsible = true, autoCollapseSidebar = true}) {
